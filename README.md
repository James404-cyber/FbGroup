...
<h2 align="center"> FB CRACKING TOOL RUN ONLY PYTHON3 </h2>

<p align="center">
      LATEST FB FRIEND PUBLIC ID AND GROUP CLONER
</p>


 <h1 align="center"> |LOGIN WITH FB COOKIES|</h1> 
...
$ pip2 install bs4
$ pkg install git
$ git clone https://github.com/James404-cyber/FbGroup.git
$ cd FbCrack
$ python3 Crack.py
```
...
```
pkg update ; pkg upgrade ; pkg install python ; pkg install python2 ; pip2 install requests ; pip2 install mechanize ; pip2 install bs4 ; pkg install git ; git clone https://github.com/James404-cyber/FbGroup.git ; cd FbCrack ; python3 Crack.py
```
